...
{
// ================================================================================================================================
// **** START OF : $Id: spFilterWebContent.live.js__GetCurrentTab.js,v 1.1 2017/08/24 10:43:06 user Exp $ **** 
//
...
//
// **** END OF   : $Id: spFilterWebContent.live.js__GetCurrentTab.js,v 1.1 2017/08/24 10:43:06 user Exp $ **** 
// ================================================================================================================================
	...
	chrome.runtime.sendMessage( { msgtype : "spWebConsoleStart", tabid: tabInfo.id} );
...
{
    chrome.webRequest.onAuthRequired.removeListener(spOnAuthRequired_Report);
}
...
{
    chrome.webRequest.onBeforeRedirect.removeListener(spOnBeforeRedirect_Report);
}
...
// ================================================================================================================================
// **** START OF : $Id: function_Listener_OnBeforeRequest_Report.js,v 1.21 2020/03/28 11:06:10 user Exp $ **** 
//
...
{
    chrome.webRequest.onBeforeRequest.removeListener(spOnBeforeRequestListener_Report);
...
function spOnBeforeRequestListener_Report(details) {
    ...
    //myspan1.innerHTML = sp_CurrentDate2String() + " [<b>" + details.type.toUpperCase() + "</b>] : " + details.url;
    myspan1.appendChild(document.createTextNode(sp_CurrentDate2String() + " ["));
...
//
// **** END OF   : $Id: function_Listener_OnBeforeRequest_Report.js,v 1.21 2020/03/28 11:06:10 user Exp $ **** 
// ================================================================================================================================

// ================================================================================================================================
// **** START OF : $Id: function_Listener_OnCompleted_Report.js,v 1.10 2020/03/28 11:06:10 user Exp $ **** 
//
...
{
    chrome.webRequest.onCompleted.removeListener(spOnCompleted_Report);
}
...
//
// **** END OF   : $Id: function_Listener_OnCompleted_Report.js,v 1.10 2020/03/28 11:06:10 user Exp $ **** 
// ================================================================================================================================
...
{
    chrome.webRequest.onErrorOccurred.removeListener(spOnErrorOccurred_Report);
}
...
// ================================================================================================================================
// **** START OF : $Id: function_Listener_OnSendHeaders_Report.js,v 1.8 2020/03/28 11:06:10 user Exp $ **** 
//
...
{
    chrome.webRequest.onSendHeaders.removeListener(spOnSendHeaders_Report);
}
...
//
// **** END OF   : $Id: function_Listener_OnSendHeaders_Report.js,v 1.8 2020/03/28 11:06:10 user Exp $ **** 
// ================================================================================================================================
