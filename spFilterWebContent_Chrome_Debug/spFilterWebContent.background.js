...
chrome.browserAction.onClicked.addListener(
    function()
    {
        ...
        var n=chrome.extension.getURL("spFilterWebContent.live.html");
...
if ( (navigator.userAgent.indexOf("Android") > 0 ) && ( navigator.userAgent.indexOf("Firefox/55") > 0 ) ) {
    ...
    var t;
    t=chrome.extension.getURL("spFilterWebContent.live.html");
    ...
    //t=chrome.extension.getURL("spFilterWebContent.options.html");
    //chrome.tabs.create({url:t});
}
...
{
    chrome.webRequest.onBeforeRequest.removeListener(spOnBeforeRequestListener_Block);
}
...
function spOnBeforeRequestListener_Block(details) {
	...
	if ( myurl.indexOf(chrome.extension.getURL("/")) >= 0 ) {
	    if (myConsoleTabId > 0 )
		sp_SendWebRequestAllowedMessage(details.requestId, "URL", "URL of extension always ALLOWED: ", "URL key=", chrome.extension.getURL("/") );
	    return { cancel: false  };
	}
    }
...
function sp_SendWebRequestBlockedMessage(RequestId, type, part01, part02, part03)
{
    ...
    // ================================================================================================================================
// **** START OF : $Id: spFilterWebContent.background.js__SendMessage.js,v 1.3 2018/01/20 11:16:09 user Exp $ **** 
//

// Implementierung fuer chrome
// https://developer.chrome.com/extensions/runtime#method-sendMessage

chrome.runtime.sendMessage( { msgtype : mymsgtype, type: type, RequestId : RequestId, part01: part01, part02 : part02, part03 : part03}, handleResponse);

//
// **** END OF   : $Id: spFilterWebContent.background.js__SendMessage.js,v 1.3 2018/01/20 11:16:09 user Exp $ **** 
// ================================================================================================================================
...
{
    chrome.webRequest.onBeforeSendHeaders.removeListener(spOnBeforeSendHeadersListener_Block);
}
...
{
    chrome.webRequest.onHeadersReceived.removeListener(spOnHeadersReceivedListener_Block);
}
